...
public class InicializaLista {
    ...
    public static List<Receita> insercaoDados (){
        ...
        Receita receita1 = new Receita("Macarrão de Panela de Pressão ", TipoReceita.SALGADA, TipoRefeicao.ALMOCO_JANTA, 283.25 ,10.0
                ...
                Junte o caldo de carne, o molho de tomate, o creme de leite e um pouco de água, misture bem e acerte o sal.
                Coloque o macarrão cru e cubra com água (até que cubra e passe 1 cm aproximadamente) e misture bem.
        ...
        Receita receita2 = new Receita("Pizza rápida", TipoReceita.SALGADA, TipoRefeicao.ALMOCO_JANTA, 396.57,13.50
                ...
                Coloque para assar em forno preaquecido por 30 minutos ou até que doure.""".indent(4),40, listaIng2
        );
        receita2.setId(id++);
        ...
        Receita receita3 = new Receita("Omelete verde", TipoReceita.SALGADA, TipoRefeicao.LANCHE,170.0,5.75
                ,"Descrição do omelete verde.",10, listaIng3
        );
        receita3.setId(id++);
        ...
        Receita receita5 = new Receita("Tapioca com ovo", TipoReceita.SALGADA,TipoRefeicao.CAFE, 200.0,4.0
                ...
                Em seguida, frite os ovos, coloque-os dentro da tapioca e feche.""".indent(4),10, listaIng5
        );
        receita5.setId(id++);
        ...
        Receita receita6 = new Receita("Sanduíche de ovo especial ", TipoReceita.SALGADA, TipoRefeicao.CAFE,190.5,2.0
                , """
        ...
        Receita receita7 = new Receita("Delícia de tomovo", TipoReceita.SALGADA,TipoRefeicao.CAFE, 230.5,15.0
                , """
                Lave bem os tomates.
                ...
                Sirva quente.""".indent(4),30, listaIng7
        );
        receita7.setId(id++);
        ...
        Receita receita9 = new Receita("Arroz doce", TipoReceita.DOCE,TipoRefeicao.ALMOCO_JANTA, 300.5,3.99
                ,"Um arroz muito doce.",13, listaIng9
        );
        receita9.setId(id++);
        ...
        Receita receita10 = new Receita("Maionese com ovo cozido ", TipoReceita.SEM_GLUTEN,TipoRefeicao.ALMOCO_JANTA, 200.5,8.0
                ...
                Vá acrescentando o óleo até dar ponto de patê.""".indent(4),18, listaIng10
        );
        receita10.setId(id++);
        ...
        Receita receita11 = new Receita("Maionese", TipoReceita.SEM_GLUTEN,TipoRefeicao.ALMOCO_JANTA, 500.5,9.0
                , """
                Bata todos os ingredientes, menos o óleo, no liquidificador.
                Vá acrescentando o óleo até dar ponto de patê.""".indent(4),18, listaIng11
        );
        receita11.setId(id++);
        ...
        Receita receita12 = new Receita("Bolinho de chuva sem ovo", TipoReceita.SEM_GLUTEN,TipoRefeicao.LANCHE, 340.0,9.0
                ...
                Arrume os bolinhos e polvilhe.""".indent(1),28, listaIng12
        );
        receita12.setId(id++);
        ...
        Receita receita13 = new Receita("Queijo presunto", TipoReceita.SEM_GLUTEN,TipoRefeicao.LANCHE, 360.0,9.0
                , """
                ...
                Após 9 minutos coloque a lata de seleta de legumes , queijo e presunto em cubinhos, mexa bem e mais 3 minutos em potência alta.""".indent(4),18, listaIng13
        );
        receita13.setId(id++);
        ...
        Receita receita14 = new Receita("Peixe ao alho", TipoReceita.SEM_GLUTEN,TipoRefeicao.LANCHE, 390.0,18.0
                , """
                ...
                Leve ao forno em temperatura média.""".indent(4),43, listaIng14
        );
        receita14.setId(id++);
        ...
        Receita receita15 = new Receita("Salsicha", TipoReceita.SEM_GLUTEN,TipoRefeicao.LANCHE, 390.0,18.0
                , """
                ...
                Depois de pronto, pode ser servido em pão francês, pão de cachorro quente, ou pode servir como mistura , acompanhado de batata palha.""",65, listaIng15
        );
        receita15.setId(id++);
        ...
        listaInicialTeste.add(receita11);
        listaInicialTeste.add(receita12);
        listaInicialTeste.add(receita13);
        listaInicialTeste.add(receita14);
        listaInicialTeste.add(receita15);
